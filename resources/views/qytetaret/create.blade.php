<x-layout headerName="Shto Qytetar">
        ...
        <div class="big-white shadow-md rounded-lg p-6">
            ...
            <form action="{{ route('qytetaret.store') }}" method="POST" class="mt-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="emri" name="emri" class="w-full px-4 py-2 border border-gray-300 rounded-md"
                           required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select id="gjinia" name="gjinia" class="w-full px-4 py-2 border border-gray-300 rounded-md"
                            required>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="viti_i_lindjes" name="viti_i_lindjes"
                           class="w-full px-4 py-2 border border-gray-300 rounded-md" required>
                </div>
